...
ggplot(data = Scenario1.NoiseBreakdown, aes(x = as.factor(Trials), y = Distortion)) +
  ...
  theme_minimal() +
  labs(title = "Distortion across Trials and Noise Levels for Scenario 1", x = "Number of Trials",
...
ggplot(data = Scenario1.NoiseBreakdown, aes(x = as.factor(Trials), y = ResidualNoise)) +
  geom_point(aes(color = as.factor(Noise))) +
  theme_minimal() +
  labs(title = "Residual Noise across Trials and Noise Levels for Scenario 1", x = "Number of Trials",
